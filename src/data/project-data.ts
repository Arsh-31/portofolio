export const projects = [
  ...
  },
  {
    title: "Anti-very",
    description:
      "A smart and playful writing tool that turns clunky “very + adjective” phrases into impactful single words, helping you express ideas with clarity, confidence, and style.",
    imageUrl: "/images/antivery.png",
    techStack: ["React", "JavaScript", "Tailwind CSS"],
    liveLink: "",
    repoLink: "https://github.com/Arsh-31/anti-very",
    status: "Running",
  },
];
